...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul  7 00:32:34 2018
...
#    for i in word:
##        print(i)
#        pointOfLetter.append(SCRABBLE_LETTER_VALUES[i])
#        
##    print(pointOfLetter)
#    sumOfPoint = sum(pointOfLetter)
##    print(sumOfPoint)
#    lenOfWord = len(word)
#    if lenOfWord == n:
#        return (sumOfPoint * lenOfWord + 50)
#    else:
#        return (sumOfPoint * lenOfWord)
def getWordScore(word, n):
    """
    Returns the score for a word. Assumes the word is a valid word.
...
##        print()
##        print(listWord)
#        lenOfWordList = len(listWord)
##        print('len of word is = ', len(listWord))
#        if listWord[lenOfWordList -1] == i:
#            return True
##                
def isValidWord(word, hand, wordList):
    """
    ...
    while True:
        ...
        if userInput == '.':
            ...
            if isValidWord(userInput,hand,wordList) == False:
                ...
                userInputListCopy = userInputList[:]
                tempScore = getWordScore(userInput, n)
                score = tempScore + score
                print('"',userInput,'"', " earned ", tempScore, " points.", "Total: ", score," points.")
                print()
...
#            playHand({'a': 1, 'd': 1, 'e': 1, 'h': 1, 'l': 1, 'm': 2, 'o': 1, 'r': 1, 'x': 1}, wordList, 7)
             playHand(hand, wordList, n)
             count += 1
        elif userInput == 'r':
            #last hand again or for new type the message
            if count == 0:
